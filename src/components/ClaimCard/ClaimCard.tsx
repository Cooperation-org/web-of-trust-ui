...
interface ClaimCardProps {
  ...
  fetchFileMetadata: (fileId: string, s: string) => Promise<void>
}
...
export const ClaimCard: React.FC<ClaimCardProps> = ({
  onAchievementLoad, content, pathname, session, fileID, storage , status, fetchFileMetadata
}) => {
